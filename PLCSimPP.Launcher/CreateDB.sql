...
/****** Object:  Database [PLCSimPP]    Script Date: 5/22/2020 10:04:23 AM ******/
CREATE DATABASE [PLCSimPP]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PLCSimPP', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\BCI.PLCSimPP.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
...
/****** Object:  Table [dbo].[MsgLog]    Script Date: 5/22/2020 10:04:39 AM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[ProcGetPageData]    Script Date: 5/22/2020 10:04:52 AM ******/
SET ANSI_NULLS ON
GO
