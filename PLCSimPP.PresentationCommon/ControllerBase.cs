using PLCSimPP.PresentationCommon.ViewData;
using System;
...
namespace PLCSimPP.PresentationCommon
{
    /// <summary>
    ...
    public class ControllerBase : INotifyPropertyChanging, INotifyPropertyChanged, IController
    {
        ...
        /// The config service
        /// </summary>
        //protected readonly IConfigService mConfigService;
        ...
        public bool Save()
        {
            //if (!Data.IsValueChanged)
            //{
            //    mDisplayMessageDialog.Display(Properties.Resources.NoContentChanged, Properties.Resources.prompting,
            //        CabernetResourceManager.GetEnglishResources(nameof(Properties.Resources.NoContentChanged), typeof(Properties.Resources)),
            //        CabernetResourceManager.GetEnglishResources(nameof(Properties.Resources.prompting), typeof(Properties.Resources)),
            //        mSetupLog, mSecurity.CurrentUserName);
            //    return false;
            //}
            if (Data.HaveError)
            {
                ...
                //mDisplayMessageDialog.Display(Properties.Resources.ContentError, Properties.Resources.Error,
                //    CabernetResourceManager.GetEnglishResources(nameof(Properties.Resources.ContentError), typeof(Properties.Resources)),
                //    CabernetResourceManager.GetEnglishResources(nameof(Properties.Resources.Error), typeof(Properties.Resources)),
                //    mSetupLog, mSecurity.CurrentUserName);
